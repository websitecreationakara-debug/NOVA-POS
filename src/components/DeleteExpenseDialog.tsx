...
import { deleteExpenseAction } from "@/app/(app)/accountance/actions";

// Same look/behavior as DeleteOrderDialog -- mount only while confirming:
// `{confirming && <DeleteExpenseDialog … />}`.
export default function DeleteExpenseDialog({
  expenseId,
  description,
  onClose,
  // Called after a successful delete, before onClose -- lets the caller
  // clear its own edit-form state if it was editing this same expense.
  onDeleted,
}: {
  expenseId: string;
  description: string;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 id="delete-expense-title" className="mt-4 text-base font-semibold text-foreground">
          Delete this expense?
        </h2>
        <p id="delete-expense-description" className="mt-1.5 text-sm text-muted-foreground">
          &quot;{description}&quot; will be removed. This can&apos;t be undone.
        </p>
